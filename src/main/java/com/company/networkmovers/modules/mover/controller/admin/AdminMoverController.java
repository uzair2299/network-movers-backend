...
public class AdminMoverController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<MoverResponse> findById(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<MoverResponse> update(@PathVariable UUID id, @RequestBody MoverRequest request) {
