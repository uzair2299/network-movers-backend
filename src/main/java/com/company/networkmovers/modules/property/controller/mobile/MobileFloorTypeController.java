...
@RestController
@RequestMapping("/api/v1/mobile/floor-type")
public class MobileFloorTypeController extends AbstractMobileLookupController<LookupRequest, LookupResponse> {

    public MobileFloorTypeController(FloorTypeService service) {
        super(service);
    }
}
