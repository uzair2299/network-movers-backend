...
@Component
public class FloorTypeMapper implements GenericMapper<FloorType, LookupRequest, LookupResponse> {

    @Override
    public FloorType toEntity(LookupRequest request) {
        if (request == null) return null;
        return FloorType.builder()
    ...
    @Override
    public LookupResponse toResponse(FloorType entity) {
