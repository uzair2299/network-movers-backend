...
public class AdminSupportController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SupportResponse> findById(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SupportResponse> update(@PathVariable UUID id, @RequestBody SupportRequest request) {
